...
| Domain | Dataset | Images | Resolution | Download |
|--------|---------|--------|------------|----------|
| Natural | Tiny-ImageNet-C | 110,000 | 64x64 | [GitHub](https://github.com/hendrycks/robustness) |
| Medical | LDCT | 3,584 paired | 362x362 | [TCIA](https://www.cancerimagingarchive.net/collection/ldct-and-projection-data/) |
| Document | DIBCO 2019 | 10 | variable | [Official](https://vc.ee.duth.gr/dibco2019/) / [GitHub](https://github.com/tanmayGIT/DIBCO_2019_All) |
| Microscopy | FMD | 3,000 | 512x512 | [GitHub](https://github.com/yinhaoz/denoising-fluorescence) |
...
│       # 11 corruptions x 5 severities x 200 classes
│
├── ldct/
│   └── test/
│       ├── low_dose/      # 3,584 synthetic noisy images
│       └── full_dose/     # 3,584 ground truth images
│
├── dibco/
│   └── 2019/
│       ├── imgs/          # 10 degraded documents
│       └── gt/            # 10 binarized ground truth
│
└── fmd/
    ├── noisy/             # 3,000 noisy microscopy images
    └── clean/             # 60 averaged clean images (50:1 ratio)
```

### Dataset Notes

- **ImageNet-C**: No clean images - uses self-supervised learning or cross-corruption transfer
- **LDCT**: Synthetic low_dose generated by adding Gaussian noise (σ=25) to ground truth
- **FMD**: 50 noisy captures averaged to create 1 clean ground truth per sample
